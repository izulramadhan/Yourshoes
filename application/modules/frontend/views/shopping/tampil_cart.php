...
<form action="<?php echo base_url()?>frontend/shopping/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="form-horizontal" enctype="multipart/form-data">
<?php
...
<tr>
<td><?php echo $i++; ?></td>
<td><img class="img-responsive" src="<?php echo base_url() . 'gambar/product/'.$item['gambar']; ?>"/></td>
...
<td><a href="<?php echo base_url()?>frontend/shopping/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a></td>
<?php endforeach; ?>
</tr>
<tr>
...
<a href="<?php echo base_url()?>frontend/shopping/check_out"  class ='btn btn-sm btn-primary'>Check Out</a>
</tr>
