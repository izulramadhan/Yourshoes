...
<div class="kotak2">
<img class="img-responsive" src="<?php echo base_url() . 'gambar/product/'.$detail['gambar']; ?>"/>
 <h5>Harga: Rp. <?php echo number_format($detail['harga'],0,",",".");?><p>Stok : <?php echo $detail['stok'];?></h5>
 <p class="card-text">
<strong> <u>Deskripsi</u></strong><br>
 ...
 <button class="btn btn-lg btn-success" type="submit"><i class="glyphicon glyphicon-shopping-cart"></i> Add to Cart</button>
 </div>
 </form>